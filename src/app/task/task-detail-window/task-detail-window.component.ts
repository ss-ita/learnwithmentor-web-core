...
@Component({
  selector: 'app-task-detail-window',
  templateUrl: './task-detail-window.component.html',
  styleUrls: ['./task-detail-window.component.css']
})
export class TaskDetailWindowComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<TaskDetailWindowComponent>,
